...
public class HasteBlade : CustomCardModel
{
    ...
    public HasteBlade() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    }
    public override string PortraitPath => $"res://axeboy/images/cards/haste_blade.png";
